package com.example.rabbitmqstudy.demo.producer.p2p;
 ...
 * @description 没有交换机的 p2p的生产者
 */
public class NoExchangeP2PProducer {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        String msg = "NoExchangeP2P";
        AMQP.Queue.DeclareOk queueDeclare = channel.queueDeclare("NoExchangeP2P-Queue", true, false, false, null);
        ...
        channel.basicPublish("", "NoExchangeP2P-Queue", true,false,null, msg.getBytes());
        System.out.println("NoExchangeP2P-Queue Producer messgae:" + msg);
        //关闭连接
        //channel.close();
        //connection.close();
    }
