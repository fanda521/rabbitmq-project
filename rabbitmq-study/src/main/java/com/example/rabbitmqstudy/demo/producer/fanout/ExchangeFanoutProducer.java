package com.example.rabbitmqstudy.demo.producer.fanout;
...
public class ExchangeFanoutProducer {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        String msg = "ExchangeFanout";
        String queueName1 ="ExchangeFanout-Queue-One";
        String queueName2 ="ExchangeFanout-Queue-Two";
        String queueName3 ="ExchangeFanout-Queue-Three";
        ...
        channel.queueBind(queueName3,exchangeName,"",null);
         ...
         * 消息内容：
         */
        channel.basicPublish(exchangeName, "", true,false,null, msg.getBytes());
        System.out.println("ExchangeFanout-Queue Producer messgae:" + msg);
