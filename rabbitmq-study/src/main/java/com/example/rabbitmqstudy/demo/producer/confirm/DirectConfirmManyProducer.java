 ...
 */
public class DirectConfirmManyProducer {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        String msg = "ExchangeDirectConfirmMany";
        String queueName1 ="DirectConfirmMany-Queue";
        String exchangeName = "Direct-ConfirmMany-Exchange";
        String routingKey1 ="Direct-ConfirmMany-Key";
        ...
        try {
            ...
            //是没有返回参数的
            channel.waitForConfirmsOrDie(1);
            System.out.println("是否确认成功：");
            System.out.println("DirectConfirmMany-Queue Producer messgae:" + msg);
        }catch (Exception e){
